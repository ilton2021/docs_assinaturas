                                ...
                                <center>
                                 ...
                                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <tr> 
                                      ...
                                      <td> <input type="text" disabled id="descricao" name="descricao" class="form-control" required="true" value="<?php echo $funcao->descricao; ?>"> </td>
                                    </tr>
                                    @endforeach
                                    <table>
                                    <tr>
                                     <td> 
                                      ...
                                      <td hidden><input hidden type="text" id="acao" name="acao" value="excluir_funcoes" /> </td>
                                     </td>
                                    </tr>
                                    </table>
                                  </form> 
