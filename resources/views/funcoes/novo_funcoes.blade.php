                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                 <center>
                                    ...
                                    <form method="POST" action="{{ \Request::route('storeFuncoes') }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <thead>
                                      <tr>
                                        <td colspan="2" style="width:800px;"> 
                                          <center><b>NOVA FUNÇÃO:</b></center>
                                        </td>
                                    </tr>
                                    </thead>
                                    <tr> 
                                    ...
                                    <table>
                                    <tr>
                                    <td> <br /> <a href="{{ route('cadastroFuncoes') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a> </td>
                                    ...
                                    <td hidden><input hidden type="text" id="acao" name="acao" value="cadastrar_nova_funcao" /> </td>
                                    </tr>
                                    </table>
                                    </form>
                                </div>
