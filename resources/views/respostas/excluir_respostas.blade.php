                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                ...
                                <center>
                                 <form action="{{ \Request::route('destroyRespostas') }}" method="POST">
                                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <table class="table table-sm table-bordered" style="width:1000px; align: center;">
                                    <thead>
                                      <tr>
                                        <td style="width:600px;" colspan="2"> 
                                         <center><b>EXCLUIR RESPOSTAS:</b></center>
                                        </td>
                                    </tr>
                                    </thead>
                                    <tr> 
                                      <td> Nome da Resposta: </td>
                                      <td> <input type="text" disabled id="descricao" name="descricao" class="form-control" required="true" value="<?php echo $respostas[0]->descricao; ?>"> </td>
                                    </tr>
                                    <table>
                                    <tr>
                                     <td> 
                                      ...
                                      <td hidden><input hidden type="text" id="acao" name="acao" value="excluir_respostas" /> </td>
                                     </td>
                                    </tr>
                                    </table>
                                  </form> 
