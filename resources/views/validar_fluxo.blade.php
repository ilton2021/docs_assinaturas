...
<body> 
	  ...
	  <input type="hidden" name="_token" value="{{ csrf_token() }}">
		  ...
		  <table class="table table-bordered" style="width: 1000px;" cellspacing="0">
		   <tr>
            <td align="left"><a href="{{ route('escolher_unidade') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a></td>
		    <td align="right"> 
			 <a href="{{ route('escolher_unidade') }}" id="Voltar" name="Voltar" type="button" class="btn btn-danger btn-sm" style="margin-top: 10px; color: #FFFFFF;"> Reprovar <i class="fas fa-undo-alt"></i> </a>
