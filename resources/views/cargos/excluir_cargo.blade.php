...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Documentos - Assinaturas HCPGESTÃO - CARGOS CADASTRO</title>
                            ...
                            <div class="ml-12">
                                ...
                                <center>
                                 ...
                                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <tr> 
                                      <td> Nome do Cargo: </td>
                                      <td> <input type="text" disabled id="nome" name="nome" class="form-control" required="true" value="<?php echo $cargo->nome; ?>"> </td>
                                    </tr>
                                    @endforeach
                                    <table>
                                    <tr>
                                     <td> 
                                      <a href="{{ route('cadastroCarg') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style=" color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a>
                                      ...
                                      <td hidden><input hidden type="text" id="acao" name="acao" value="excluir_cargos" /> </td>
                                     </td>
                                    </tr>
                                    </table>
                                  </form> 
