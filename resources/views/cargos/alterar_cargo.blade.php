                            ...
                            <div class="ml-12">
                                ...
                                <form action="{{ \Request::route('updateCarg') }}" method="POST">
                                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <tr> 
                                      <td> Nome do Cargo: </td>
                                      <td> <input type="text" id="nome" name="nome" class="form-control" required="true" value="<?php echo $cargo->nome; ?>"> </td>
                                    </tr>
                                    @endforeach
                                    <table>
                                    <tr>
                                     <td> 
                                        ...
                                        <td hidden><input hidden type="text" id="acao" name="acao" value="alterar_cargos" /> </td>
                                     </td>
                                    </tr>
                                    </table>
                                  </form>
