...
<html>
	...
	<body class="is-preload">
            ...
            <section id="portfolio1" class="two">
				<div class="container">
                  <table class="table table-sm" style="margin-top: 150px; width: 600px;">
                    <tr>
                      <td>
                        <div class="card-body text-center">
                          <a style="margin-left: 180px; width: 340px; height: 50px; text-align: center; justify-content: center; align-items: center; display: flex;" href="{{ route('documentosCriados') }}" class="button">DOCUMENTOS CRIADOS</a>
                        </div>
                      </td>
                      <td>
                        <div class="card-body text-center">
                          <a style="margin-left: 130px; width: 370px; height: 50px; text-align: center; justify-content: center; align-items: center; display: flex;" href="{{ route('documentosAprovados') }}" class="button">DOCUMENTOS APROVADOS</a>
                        </div>
                      </td>
                    </tr>
                 </table><br><br>
